...
set visualbell
set noerrorbells
set hidden             " switch between buffers without having to save first (unsure)
" }}}
" FileType specific
" temp test
nnoremap <buffer> <localleader>c :call ToggleComment('#')<cr>
" seems too easy...
vnoremap <buffer> <localleader>c :call ToggleComment('#')<cr>
...
augroup filetype_vim
  ...
  " is this correct?
  autocmd FileType vim vnoremap <buffer> <localleader>c :call ToggleComment('"')<cr>
augroup END
" }}}
...
augroup filetype_javascript
  ...
  autocmd FileType javascript vnoremap <buffer> <localleader>c :call ToggleComment('//')<cr>
  autocmd FileType javascript inoremap <buffer> rn<space> return<space>
...
" this is bad, should toggle, should handle nested, not just the only ()
nnoremap <leader>() mm0f(a<space><esc>h%i<space><esc>`m2l
inoremap <leader>() <esc>lmm0f(a<space><esc>h%i<space><esc>`ma
